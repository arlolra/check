...
func TestExitListLoading(t *testing.T) {
	...
	// TODO: Update to relative implementation
...
func TestIsAcceptRules(t *testing.T) {
	// Testing load
	testData := `{"Rules": [{"IsAccept": false, "MinPort": 706, "MaxPort": 706, "Address": null}], "IsAllowedDefault": false, "Address": "111.111.111.111"}
				 {"Rules": [{"IsAccept": true, "MinPort": 706, "MaxPort": 706, "Address": null}], "IsAllowedDefault": false, "Address": "222.222.222.222"}`
...
func TestIsDefaultAllowedPolicy(t *testing.T) {
	// Testing load
	testData := `{"Rules": [{"IsAccept": false, "MinPort": 706, "MaxPort": 706, "Address": null}], "IsAllowedDefault": true, "Address": "111.111.111.111"}
				 {"Rules": [{"IsAccept": true, "MinPort": 706, "MaxPort": 706, "Address": null}], "IsAllowedDefault": false, "Address": "222.222.222.222"}`
	exits := setupExitList(t, testData)
...
func TestAcceptIPOnly(t *testing.T) {
	// Testing load
	testData := `{"Rules": [{"IsAccept": false, "MinPort": 706, "MaxPort": 706, "Address": "38.229.70.31"}], "IsAllowedDefault": true, "Address": "111.111.111.111"}
				 {"Rules": [{"IsAccept": true, "MinPort": 706, "MaxPort": 706, "Address": "38.229.70.31"}], "IsAllowedDefault": false, "Address": "222.222.222.222"}`
	exits := setupExitList(t, testData)
